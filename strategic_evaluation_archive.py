# This is old version of strategy_evaluation which was based on strategy be a single matrix of size
# number_of_hands*number_of_public_state
import copy
import numpy as np
...
KTS = world_node_strategic_evaluation(test_start_one, K)
